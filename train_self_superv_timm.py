...
def parse_args():
    ...
    parser.add_argument("--net", type=str, default='timm.swinv2_tiny_window8_256')
...
def load_last_checkpoint(dir_to_checkpoint, model, optimizer=None, name=None):
    if name is None:
...
def main():
    ...
    s = args.net
    n = s.split('.')[-1]
    model = create_model(arch= n, alg=alg_f, hvd=hvd,
